...
type ValidationFormFields = "confirmed" | "corrected" | "notes" | "diagnosis" | "treatment";

function ValidationFormDialog({
  states,
  setters,
  onSave,
  onCancel,
}: {
  states: Record<ValidationFormFields, string>;
  setters: Record<
    `set${Capitalize<ValidationFormFields>}`,
